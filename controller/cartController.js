...
async function updatedCartController(req, res, next) {
  ...
  if(error){
    ...
    const updated = await cartService.updatedCart(cartId, updateCartData, value);
    res.send(updated);
...
module.exports = {cartsController, addCartController, updatedCartController, deleteCartController};